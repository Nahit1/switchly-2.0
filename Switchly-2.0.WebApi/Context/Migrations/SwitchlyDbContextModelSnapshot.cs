            ...
            modelBuilder.Entity("Switchly_2._0.WebApi.Entities.FeatureFlag", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTimeOffset(new DateTime(2025, 12, 27, 13, 59, 23, 256, DateTimeKind.Unspecified).AddTicks(5590), new TimeSpan(0, 0, 0, 0, 0)),
            ...
            modelBuilder.Entity("Switchly_2._0.WebApi.Entities.FeatureFlagEnvironment", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            UpdatedAt = new DateTimeOffset(new DateTime(2025, 12, 27, 13, 59, 23, 256, DateTimeKind.Unspecified).AddTicks(5590), new TimeSpan(0, 0, 0, 0, 0))
                        },
                        new
                        {
